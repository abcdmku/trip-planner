...
export function TypeIcon({ type, size = 'md', showBackground = true }: TypeIconProps) {
  ...
  return (
    <span className={`inline-flex items-center justify-center rounded-lg ${config.bg} ${sizeClasses[size]}`}>
