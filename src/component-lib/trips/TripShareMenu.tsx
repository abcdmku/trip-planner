...
export interface TripShareMenuProps {
  canManage: boolean;
  members: TripMember[];
      ...
      {open ? (
        <div className="absolute right-0 top-full z-50 mt-2 w-[320px] rounded-2xl border border-theme bg-theme-elevated p-4 shadow-theme-lg">
          <div className="mb-3">
            ...
            <p className="text-xs text-theme-tertiary">Owners can invite editors and manage members.</p>
          </div>
          ...
          <div className="space-y-3">
            <div>
              <div className="mb-1 text-[11px] font-semibold uppercase tracking-wide text-theme-tertiary">Members</div>
                  ...
                  {pendingInvites.map((invite) => (
                    <div key={invite.inviteId} className="flex items-center gap-2 rounded-xl border border-theme-subtle px-3 py-2">
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="truncate text-[11px] text-theme-tertiary">Invited by {invite.invitedByName}</div>
                      </div>
                      <span className="rounded-full bg-theme-subtle px-2 py-0.5 text-[10px] font-semibold uppercase text-theme-secondary">
                        {invite.role}
                      </span>
